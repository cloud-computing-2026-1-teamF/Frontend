...
export function PainPoints() {
  const items = [
    ...
    { n: '04', title: '불확실한 의사결정', as: '"여기 사람 많더라"는 직관으로 수천만 원 권리금 결정', to: '카페·한식·치킨 등 업종별 Top 3 공실매물 비교 제공' },
  ];
  return (
...
export function Features() {
  const items = [
    { icon: 'coffee', color: '#E85D1F', bg: 'var(--brand-100)', title: '업종별 맞춤 분석', desc: '한식·카페·치킨·분식·베이커리·일식·주점·양식·중식·패스트푸드 10개 요식업 업종에 맞춰 드려요' },
