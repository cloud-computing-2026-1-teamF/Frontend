...
export function PainPoints() {
  const items = [
    ...
    { n: '02', title: '분석 전문성 부재', as: '데이터가 있어도 "내 카페가 여기서 자리 잡을까?" 알 수 없음', to: '업종에 맞는 예상 생존률을 한 눈에 확인' },
...
export function Features() {
  const items = [
    ...
    { icon: 'cpu', color: '#3B6FE8', bg: 'var(--blue-100)', title: '예상 생존률(%)', desc: '유동인구·경쟁·동네 평균 추정 매출을 종합해 백분율로 한눈에 보여드려요' },
...
export function ProductTour() {
  const pages = [
    ...
    },
    {
      ...
      title: '공실탐색',
      tag: '매물 인벤토리',
      desc: '서울 공실을 지도와 표로 동시에 살펴보고 예상 생존률, 임대 부담, 유동인구, 접근성 데이터를 빠르게 비교해요.',
